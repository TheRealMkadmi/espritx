...
class UserNormalizer implements NormalizerInterface, CacheableSupportsMethodInterface
{
  ...
  public function normalize($object, $format = null, array $context = []): array
  {
    return [
      ...
      'groups' => array_map(static fn(\App\Entity\Group $g) => ["id" => $g->getId(), "title" => $g->getDisplayName()], $object->getGroups()->toArray()),
      'individualPermissions' => array_map(static fn(\App\Entity\Permission $g) => ["id" => $g->getId(), "title" => $g->getTitle()], $object->getIndividualPermissions()->toArray()),
